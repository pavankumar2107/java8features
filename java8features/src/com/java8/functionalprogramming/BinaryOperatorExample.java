...
public class BinaryOperatorExample {
	...
	public static void main(String[] args) {
		...
		System.out.println(intBi.applyAsInt(2, 6));

		LongBinaryOperator longBinaryOperator = (a, b) -> a * b;
		System.out.println(longBinaryOperator.applyAsLong(4L, 6L));

		DoubleBinaryOperator doubleBinaryOperator = (a, b) -> a * b;
		System.out.println(doubleBinaryOperator.applyAsDouble(2.00, 5.00));
	}
